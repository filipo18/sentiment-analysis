...
class IngestionService:
    ...
    async def run_once(self, products: List[str], subreddits: List[str] | None = None) -> None:
        ...
        await self._ingest_reddit(products, subreddits=subreddits)
    
    async def _ingest_reddit(self, products: List[str], subreddits: List[str] | None = None) -> None:
        ...
        for product in products:
            await self._ingest_reddit_product(product, subreddits=subreddits)
    
    async def _ingest_reddit_product(self, product: str, subreddits: List[str] | None = None) -> None:
